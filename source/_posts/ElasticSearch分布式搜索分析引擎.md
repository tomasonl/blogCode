---
title: ElasticSearch分布式搜索分析引擎-A
date: 2020-12-09 15:33:10
tags: 工作记录
...
---
## 旅程目标：
1. 能够理解ElasticSearch服务是什么？
2. 能够使用Postman发送Restful请求操作ElasticSearch
3. 理解分词器的作用、集成IK分词器、完成es集群搭建
# 第一章 ElasticSearch简介
...
<img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1584250290822&di=0f7ca8066c95a7748289cac348c99db1&imgtype=0&src=http%3A%2F%2Fku.90sjimg.com%2Felement_origin_min_pic%2F00%2F92%2F56%2F0656f228207555b.jpg" width="30" height="30" align=left> [安装包下载elasticsearch-5.6.8.zip](/download/elasticsearch-5.6.8.zip)<br>
<img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1584250290822&di=0f7ca8066c95a7748289cac348c99db1&imgtype=0&src=http%3A%2F%2Fku.90sjimg.com%2Felement_origin_min_pic%2F00%2F92%2F56%2F0656f228207555b.jpg" width="30" height="30" align=left> [安装包下载elasticsearch-analysis-ik-5.6.8.zip](/download/elasticsearch-analysis-ik-5.6.8.zip)<br>
<img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1584250290822&di=0f7ca8066c95a7748289cac348c99db1&imgtype=0&src=http%3A%2F%2Fku.90sjimg.com%2Felement_origin_min_pic%2F00%2F92%2F56%2F0656f228207555b.jpg" width="30" height="30" align=left> [安装包下载elasticsearch-head-master.zip](/download/elasticsearch-head-master.zip)
...
1）elasticsearch-head-master解压到任意目录，但是要和elasticsearch的安装目录区别开
2）安装node环境：<https://nodejs.org/en/download/> 。
3）将grunt安装为全局命令 ----Grunt是基于Node.js的项目构建工具
```
npm install -g grunt-cli
```
4）进入elasticsearch-head-master目录启动head
```
>npm install
>grunt server
```
5）打开浏览器，输入 http://localhost:9100，
如果不能成功连接到es服务，需要修改ElasticSearch的config/elasticsearch.yml，增加：
```
http.cors.enabled: true
http.cors.allow-origin: "*"
```
允许elasticsearch跨域访问。重新启动ElasticSearch服务。
<img src="https://tomasonl.oss-cn-hangzhou.aliyuncs.com/ES%E5%90%AF%E5%8A%A8head%E5%9B%BE%E5%BD%A2%E5%8C%96%E7%95%8C%E9%9D%A2.png?Expires=1607908603&OSSAccessKeyId=TMP.3Kewx9TYbp6dwqsvxxTn1vS9Z8WrNs2rZFtRNXxDodd5YfXq7d8tk827LDuDE6hkaqaXsZJJDjfwWx3Dhdv5dXiW9Lsc7x&Signature=o5EtCZKZQTxsiUE2LXQ0j1OPk6I%3D">
